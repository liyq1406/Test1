...
- (id)initWithSelect:(void(^)(id data))select;
{
    ...
    if ((self = [super initWithFrame:CGRectMake(0, -DeviceW / 2.13, DeviceW, DeviceW / 2.13)])) {
        self.delegate = self;
...
- (void)setData:(NSArray *)data
{
    ...
    for (int i = 0;i < _data.count; i ++)
    {
        ...
        view.tag = i;
        [view sd_setImageWithURL:[NSURL URLWithString:dic[@"advertImg"]] placeholderImage:[UIImage imageNamed:@"bk_5_2.png"]];
