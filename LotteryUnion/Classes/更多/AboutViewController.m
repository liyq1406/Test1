...
//    label.center = footView.center;
    ...
    _officialwebLabel.text = [mainBundle objectForKey:@"CFBundleShortVersionString"];
...
-(void)_initSubViews
{
    ...
    NSDictionary *mainBundle = [[NSBundle mainBundle] infoDictionary];
    NSString *appName = [NSString stringWithFormat:@"%@ %@",[[[NSBundle mainBundle] localizedInfoDictionary] objectForKey:@"CFBundleDisplayName"],[mainBundle objectForKey:@"CFBundleShortVersionString"]];
