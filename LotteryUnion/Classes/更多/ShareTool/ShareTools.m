...
+ (void)shareAllButtonClickHandler:(NSString *)activityName andUser:(NSString *)activityUser andUrl:(NSString *)activityUrl andDes:(NSString *)activityImageUrl
{
    ...
    id<ISSContent> publishContent = [ShareSDK content:activityName
                                       defaultContent:@"彩票联盟"
                                                ...
                                                title:@"快来加入彩票联盟吧~"
                                                  url:activityUrl.length?activityUrl:APPDownloadAdrees// 跳转的网页
                                          description:nil
    ...
    [publishContent addWeixinTimelineUnitWithType:[NSNumber numberWithInteger:SSPublishContentMediaTypeNews]
                                          content:activityName.length?activityName:@"彩票联盟"
                                            title:activityUser
                                              url:activityUrl.length?activityUrl:APPDownloadAdrees
    ...
    [publishContent addSMSUnitWithContent:[NSString stringWithFormat:@"快来加入彩票联盟吧,下载地址:%@",APPDownloadAdrees]];
