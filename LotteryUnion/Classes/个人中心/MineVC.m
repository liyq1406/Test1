...
- (void)_createHeadView {
    ...
    NSString *text = @"0.00元[转账]";//@"19.5元[转账]";
...
{
    //充值余额
    NSMutableAttributedString *mattrstring_charge = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@元[转账]",[[UserInfo sharedInstance]Balance]]];
